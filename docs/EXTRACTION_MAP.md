...
- `/home/christopherbailey/homelab-llm/services/litellm-orch` (configs, docs, scripts)
- `/home/christopherbailey/homelab-llm/services/ov-llm-server` (OpenVINO backend)
...
## Notes
- Open WebUI systemd unit uses `/home/christopherbailey/homelab-llm/services/open-webui`.
