...
class TestChatgptAliasContract(unittest.TestCase):
    def test_chatgpt_alias_points_to_ccproxy(self):
        ...
        self.assertEqual(params["api_base"], "os.environ/CCPROXY_API_BASE")
        self.assertEqual(params["api_key"], "os.environ/CCPROXY_AUTH_TOKEN")
